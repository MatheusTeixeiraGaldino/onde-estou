  ...
  return (
    <div className="space-y-4 animate-fade-in">
      ...
      {loading ? (
        ...
        <div className="text-center py-10 text-stone-400">Nenhuma pessoa encontrada</div>
      ) : (
            ...
            return (
              <div key={uid} className="card-hover">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 rounded-xl bg-stone-100 border border-stone-200 flex items-center justify-center text-xl flex-shrink-0">
                    {u.emoji || '👤'}
                  </div>
